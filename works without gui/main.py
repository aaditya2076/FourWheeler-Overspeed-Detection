...
#video 
video_src = "Assets_videos/traffic5.mp4"
base_name = os.path.splitext(os.path.basename(video_src))[0]
unique_filename = str(uuid.uuid4())
output = f"outputs/result_{unique_filename}.mp4"
match base_name:
    case 'traffic5': #has 524 frames about 13min
    ...
    case 'traffic_highway_processed':
...
def main(_argv):
    ...
    plt.savefig(f'Speed Analysis_of_{base_name}.png')
